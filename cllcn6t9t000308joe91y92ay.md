...
For that, the docker-compose needs to be installed. I have given a detailed explanation of the installation of docker-compose in the blog: [Docker Compose Installation](https://muditm12.hashnode.dev/day-18-docker-compose-for-devops-engineers).
