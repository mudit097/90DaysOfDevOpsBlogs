...
![](https://miro.medium.com/v2/resize:fit:875/0*AkPwtQkeok_EC32m.png align="left")

2\. Make some changes to the files 📝 in the **dev** branch.

![](https://miro.medium.com/v2/resize:fit:875/0*AkLM927udsLFGjz_.png align="left")
...
![](https://miro.medium.com/v2/resize:fit:875/0*e_KLLIfTtdAlZet_.png align="left")

4\. Use following the command to switch to the **main** branch and proceed with important tasks.

![](https://miro.medium.com/v2/resize:fit:875/0*KemEAAX2jia1iUW0.png align="left")
...
![](https://miro.medium.com/v2/resize:fit:875/0*N1uO23tX757s0_Sc.png align="left")

![](https://miro.medium.com/v2/resize:fit:875/0*gg9ifquaBhJWKWPb.png align="left")
...
![](https://miro.medium.com/v2/resize:fit:875/0*-2L28vYadeRRnnwz.png align="left")
...
![](https://miro.medium.com/v2/resize:fit:875/0*qagp7AcicCBt82Qx.png align="left")
...
![](https://miro.medium.com/v2/resize:fit:875/0*brFq3wg_EOHosmpv.png align="left")

4\. 🚀 Create a prod branch and use **git rebase** to include all the commits from the dev branch into the prod branch.

![](https://miro.medium.com/v2/resize:fit:875/0*oYk9royj87z2fiwn.png align="left")
...
![](https://miro.medium.com/v2/resize:fit:875/0*HvgUNg_vMM7VhL-M.png align="left")
...
![](https://miro.medium.com/v2/resize:fit:875/0*dfi91A9G3CUwwEn_.png align="left")
